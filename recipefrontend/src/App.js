  ...
  newRecipeOnSubmit(event) {
    ...
    axios
      ...
      .then((response) => {
        ...
        // assigning response.data to newRecipe, so can edit format of date
        // and then pass newRecipeEditedDate in to be pushed onto recipeList
        const newRecipe = response.data;
        const recipeListDateAdded = new Date(
          response.data.dateAdded
        ).toDateString();

        const newRecipeEditedDate = {
          ...newRecipe,
          dateAdded: recipeListDateAdded,
        };

        recipeList.push(newRecipeEditedDate);
    ...
    return (
      <div className="App">
        ...
        <ul className="recipeList">
          {this.state.recipeList.map((recipe, index, _id) => {
            return (
